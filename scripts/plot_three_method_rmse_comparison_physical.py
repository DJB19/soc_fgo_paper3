...
# Physically constrained capacity-aware FGO
...
df_all.to_csv(RESULT_DIR / "B0005_three_method_rmse_comparison_physical.csv", index=False)
...
positions = {
    ...
    "Physical CA-FGO": [i + width for i in x],
}
...
out_path = FIG_DIR / "B0005_three_method_rmse_comparison_physical.png"
plt.savefig(out_path, dpi=300)
plt.close()

print("Saved figure:", out_path)
print("Saved table:", RESULT_DIR / "B0005_three_method_rmse_comparison_physical.csv")
print()
